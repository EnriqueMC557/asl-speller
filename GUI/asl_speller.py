...
class Ui_ASLSPELLER(object):
    def setupUi(self, ASLSPELLER):
        ...
        self.start_button = QtWidgets.QPushButton(ASLSPELLER)
        self.start_button.setGeometry(QtCore.QRect(380, 730, 112, 34))
        self.start_button.setObjectName("start_button")
        self.finish_button = QtWidgets.QPushButton(ASLSPELLER)
        self.finish_button.setGeometry(QtCore.QRect(600, 730, 112, 34))
    ...
    def retranslateUi(self, ASLSPELLER):
        ...
        self.start_button.setText(_translate("ASLSPELLER", "Start"))
        self.finish_button.setText(_translate("ASLSPELLER", "Finish"))
